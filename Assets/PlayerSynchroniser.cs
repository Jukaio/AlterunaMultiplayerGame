...
public class PlayerSynchroniser : Synchronizable
{
    public override void AssembleData(Writer writer, byte LOD = 100)
    {
        ...
        var query = manager.CreateEntityQuery(typeof(Player), typeof(Position), typeof(Local));
    ...
    {
        var manager = World.DefaultGameObjectInjectionWorld.EntityManager;
        var query = manager.CreateEntityQuery(typeof(Player), typeof(Position), typeof(Remote));
        ...
        //     var entity = manager.CreateEntity(typeof(Player), typeof(Position), typeof(Remote));
        //     entities.Add(entity);
        // }
